    ...
    if (widget.leading == null &&
      ...
      if (isCurrent) {
        final backButton = Container(
          // 62px accounts for the iPadOS system window toolbar width in
          // windowed mode. Fix Neo 02/09: SOLO iOS — en macOS cualquier
          // ventana es "windowed" según _getIsWindowed() y el margin
          // dejaba el back button ~62px separado de la esquina, pegado
          // al centro del área libre (no existe toolbar de sistema
          // lateral en macOS).
          margin: EdgeInsets.only(
            left: PlatformInfo.isIOS && _getIsWindowed() ? 62 : 0,
          ),
          height: 38,
          width: 38,
        ...
        if (hasToolbarContent)
          Positioned(
            ...
            child: IOS26NativeToolbar(
              ...
              // Back automático: el botón glass nativo ya trae su padding
              // interno (cápsula) — un overlay a 16px añadía un segundo
              // padding y dejaba el chevron ~25pt del borde (bug iPhone).
              // leadingLeft 0 → chevron al inset estándar de iOS (~8-10pt).
              leadingLeft: widget.leading != null ? 16.0 : 0.0,
