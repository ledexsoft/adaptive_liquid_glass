...
class IOS26NativeTabBar extends StatefulWidget {
  ...
  /// Solo iconos (sin texto) en pantallas pequeñas: la UITabBar crea los
  /// items con título vacío y el label real va en accessibilityLabel.
...
class _IOS26NativeTabBarState extends State<IOS26NativeTabBar> {
  ...
  Widget build(BuildContext context) {
    if (!kIsWeb && Platform.isIOS) {
      ...
      final platformView = widget.showNativeView
          ? UiKitView(
              viewType: 'adaptive_liquid_glass/ios26_tab_bar',
  ...
  void _onCreated(int id) {
    final ch = MethodChannel('adaptive_liquid_glass/ios26_tab_bar_$id');
    _channel = ch;
