import 'package:adaptive_liquid_glass_example/service/router/router_service.dart';
            ...
            items: [
              ...
              _DemoItem(
                icon: PlatformInfo.isIOS
                    ...
                    : Icons.search,
                title: 'Search · Divider · SwitchList',
                description:
                    'Adaptive search bar, divider and switch list tiles',
                routeName: RouterService.routes.searchDividerSwitch,
                isNew: true,
              ),
              _DemoItem(
                icon: PlatformInfo.isIOS
