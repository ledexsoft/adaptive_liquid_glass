...
class iOS26SearchTabBarController: UITabBarController, UISearchResultsUpdating, UISearchBarDelegate {
    ...
    init(viewId: Int64, args: [String: Any]?, messenger: FlutterBinaryMessenger) {
        self.channel = FlutterMethodChannel(
            name: "adaptive_liquid_glass/ios26_search_tab_bar_\(viewId)",
    ...
    private func setupTabBarAppearance() {
        ...
        // UITabBar applies the native Liquid Glass appearance automatically on
        // iOS 26 when configured with the default background.
