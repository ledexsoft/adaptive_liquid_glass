...
class iOS26ToolbarPlatformView: NSObject, FlutterPlatformView {
    ...
    init(
        ...
        channel = FlutterMethodChannel(
            name: "adaptive_liquid_glass/ios26_toolbar_\(viewId)",
            binaryMessenger: messenger
        )
    ...
    private func setupNavigationBar() {
        ...
        // 24/08 (pedido Carlos): en iPhone el back button queda pegado al
        // borde izquierdo (leading margin 0); en iPad se conserva el inset
        // estándar. Solo afecta el leading — las acciones de la derecha no
        // se tocan.
