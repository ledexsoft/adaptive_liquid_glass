...
void main() {
  ...
  group('AdaptiveScaffold', () {
    ...
    testWidgets('hideLabels se propaga al IOS26NativeTabBar', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      // AdaptiveBottomNavigationBar es un objeto de configuración (no un
      // Widget en el árbol); el hideLabels se lee vía el AdaptiveScaffold.
      final scaffold = tester.widget<AdaptiveScaffold>(
        find.byType(AdaptiveScaffold),
      );
      final navBar = scaffold.bottomNavigationBar!;
      expect(navBar.hideLabels, isTrue);
    });
